...
train_pipeline = [
    ...
    dict(type='MergeCategory', merge_groups=[['Oven_TopHandle', 'Oven_BottomHandle'],['Oven_TopInner', 'Oven_BottomInner']],
         ann_file='data/pose-dataset/BakingRefine/annotations/train260817.json'),
...
val_pipeline = [
    ...
    dict(type='TopdownAffine', input_size=codec['input_size']),
    dict(type='MergeCategory', merge_groups=[['Oven_TopHandle', 'Oven_BottomHandle'],['Oven_TopInner', 'Oven_BottomInner']],
         ann_file='data/pose-dataset/BakingRefine/annotations/val260817e.json'),
    dict(type='PackPoseInputs'),
]
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='annotations/val260817e.json',
        data_prefix=dict(img='images/'),
        test_mode=True,
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'annotations/val260817e.json',
    symmetry_pairs=[(0, 2), (1, 3)],
    symmetry_categories=[0, 1, 2],
