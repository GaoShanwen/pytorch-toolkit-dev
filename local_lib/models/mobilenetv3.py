...
class MobileNetV3Redution(MobileNetV3):
    ...
    def __init__(
        ...
        super(MobileNetV3Redution, self).__init__(block_args,
            num_classes, in_chans, stem_size, fix_stem, num_features, head_bias, pad_type,
            act_layer, norm_layer, se_layer, se_from_exp, round_chs_fn, drop_rate, drop_path_rate,
            global_pool
        )
        del self.classifier
