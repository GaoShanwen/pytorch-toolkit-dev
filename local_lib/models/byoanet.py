...
class ByobRedutionNet(ByobNet):
    def __init__(
        ...
        super(ByobRedutionNet, self).__init__(cfg,  # type: ignore
            num_classes, in_chans, global_pool, output_stride, img_size,
            drop_rate, drop_path_rate, zero_init_last, **kwargs,
        )
        del self.head.fc
...
def _create_byoanet(variant, cfg_variant=None, pretrained=False, **kwargs):
    return build_model_with_cfg(
        ByobRedutionNet, variant, pretrained,
