...
parser.add_argument('-c', "--cats-path", type=str, 
                    default='dataset/exp-data/blacklist/save_cats.txt')
parser.add_argument("--need-cats", type=str,
                    default='dataset/exp-data/blacklist/need_cats.txt')
...
def run_infer(model, args):
    ...
    with open(args.cats_path, 'r') as f: class_list = [line.strip('\n') for line in f.readlines()]
    with open(args.need_cats, 'r') as f: need_list = [class_list.index(line.strip('\n')) for line in f.readlines()]
