...
def train(args):
    model = YOLO(f'{args.model_type}.yaml').load(f'{args.model_type}.pt')
    model.train(
...
def get_args():
    ...
    parser.add_argument("-m", "--model", help="yolov(8,9,11)(n,s,m,l,x)写一个字母就行", default="yolov8s.pt", type=str)
