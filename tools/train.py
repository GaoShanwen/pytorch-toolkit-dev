...
group.add_argument('--cats-path', default='', type=str, metavar='PATH',
                   help='path of dataset categories (default: none, current dir)')
group.add_argument('--pass-path', default='dataset/exp-data/zero_dataset/pass_cats.txt', type=str, metavar='PATH',
