...
def main():
    ...
    parser.add_argument('--kpt-onnx', type=str,
                        default='ckpts/rtmpose/BakingRefine/202608172328/best_coco_AP_epoch_70.onnx')
